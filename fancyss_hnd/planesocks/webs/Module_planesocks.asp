...
<link rel="stylesheet" type="text/css" href="/res/planesocks.css">
...
function save() {
	...
	//---------------------------------------------------------------
	dbus["ss_basic_ping_node"] = "off";
	db_ss["ss_basic_ping_node"] = "off";
	var post_dbus = compfilter(db_ss, dbus);
	post_dbus["ss_basic_ping_node"] = "off";
...
function version_show() {
	...
	$.ajax({
		url: 'https://raw.githubusercontent.com/fastbash/fancyss/master/fancyss_hnd/config.json.js',
		type: 'GET',
		dataType: 'json',
...
function toggle_func() {
	...
	$("#update_log").click(
		function() {
			window.open("https://github.com/fastbash/fancyss/blob/master/fancyss_hnd/Changelog.txt");
		});
	$("#log_content2").click(
		function() {
			x = -1;
												...
												<th id="ss_switch">科学上网开关</th>
													<td colspan="2">
														...
														<div style="display:table-cell;float: left;margin-left:270px;position: absolute;padding: 5.5px 0px;">
															<a type="button" class="ss_btn" target="_blank" href="https://github.com/fastbash/fancyss/blob/master/fancyss_hnd/Changelog.txt">更新日志</a>
														</div>
												...
												<script type="text/javascript">
													...
													$('#table_rules').forms([
														{ title: 'gfwlist域名数量', multi: [
															...
															{ suffix: '<a href="https://github.com/fastbash/fancyss/blob/master/rules/gfwlist.conf" target="_blank">' },
															{ suffix: '<i><% nvram_get("update_ipset"); %></i></a>' },
														]},
														{ title: '大陆白名单IP段数量', multi: [
															{ suffix: '<em>'+ chnl +'</em>&nbsp;行，包含 <em>' + chnn + '</em>&nbsp;个ip地址，版本：' },
															{ suffix: '<a href="https://github.com/fastbash/fancyss/blob/master/rules/chnroute.txt" target="_blank">' },
															{ suffix: '<i><% nvram_get("update_chnroute"); %></i></a>' },
														]},
														{ title: '国内域名数量（cdn名单）', multi: [
															{ suffix: '<em>'+ cdnn +'</em>&nbsp;条，版本：' },
															{ suffix: '<a href="https://github.com/fastbash/fancyss/blob/master/rules/cdn.txt" target="_blank">' },
											...
											<table id="table_subscribe" style="margin:8px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
												<script type="text/javascript">
													...
													$('#table_subscribe').forms([
														...
														{ title: '订阅计划任务', multi: [
															{ id:'ss_basic_node_update', type:'select', style:'width:auto', func:'u', options:[["0", "禁用"], ["1", "开启"]], value:'1'},
															{ id:'ss_basic_node_update_day', type:'select', style:'width:auto', options:option_noded, value:'7'},
											...
											<table id="table_addons" style="margin:-1px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" >
												<script type="text/javascript">
													...
													$('#table_addons').forms([
														...
														{ title: '&nbsp;&nbsp;&nbsp;&nbsp;ping测试设置', style:'display:none;', multi: [
															{ id:'ss_basic_ping_node', type:'select', style:'width:auto;max-width:220px;display:none;', func:'onchange="ping_switch();"', options:[], value:'off'},
															{ id:'ss_basic_ping_method', type:'select', style:'display:none;width:auto;', help:'109', options:pingm, value:'1'},
															{ suffix:'&nbsp;<input id="ss_basic_ping_btn" class="ss_btn" style="display:none;cursor:pointer;" onClick="ping_now()" type="button" value="开始ping！"/>'},
														]},
