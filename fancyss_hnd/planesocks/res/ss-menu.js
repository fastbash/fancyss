...
function menu_hook() {
	...
	tablink[tablink.length - 1] = new Array("", "Module_planesocks.asp", "Module_planesocks_lb.asp", "Module_planesocks_local.asp", "NULL");
}
...
function LoadingSSProgress(seconds) {
	...
	if (action == 0) {
		...
		$("#loading_block2").html("<li><font color='#ffcc00'><a href='https://github.com/fastbash/fancyss' target='_blank'></font>插件工作有问题？请到<em>GITHUB</em>提交issue...</font></li>");
	} else if (action == 1) {
...
function openssHint(itemNum) {
	...
	if (itemNum == 1) {
		...
		statusmenu += "</br>&nbsp;&nbsp;&nbsp;&nbsp;wget --no-check-certificate https://raw.githubusercontent.com/fastbash/fancyss_history_package/master/fancyss_hnd/shadowsocks_1.5.7.tar.gz";
		...
		statusmenu += "</br>回滚其它版本号，请参考<a href='https://github.com/fastbash/fancyss_history_package/tree/master/fancyss_hnd' target='_blank'><u><font color='#00F'>版本历史列表</font></u></a>";
