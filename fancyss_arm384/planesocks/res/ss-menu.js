...
function openssHint(itemNum) {
	...
	if (itemNum == 1) {
		...
		statusmenu += "</br>&nbsp;&nbsp;&nbsp;&nbsp;wget --no-check-certificate https://raw.githubusercontent.com/fastbash/fancyss_history_package/master/fancyss_arm384/planesocks_1.0.0.tar.gz";
		statusmenu += "</br>&nbsp;&nbsp;&nbsp;&nbsp;mv planesocks_1.0.0.tar.gz planesocks.tar.gz";
		statusmenu += "</br>&nbsp;&nbsp;&nbsp;&nbsp;tar -zxvf /tmp/planesocks.tar.gz";
		statusmenu += "</br>&nbsp;&nbsp;&nbsp;&nbsp;chmod +x /tmp/planesocks/install.sh";
		statusmenu += "</br>&nbsp;&nbsp;&nbsp;&nbsp;sh /tmp/planesocks/install.sh";
		...
		_caption = "planesocks for merlin 版本";
	} else if (itemNum == 13) {
