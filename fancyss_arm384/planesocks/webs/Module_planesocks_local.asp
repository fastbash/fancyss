...
<title>planesocks - Socks5代理设置</title>
...
<body onload="init();">
	...
	<input type="hidden" name="current_page" value="Module_planesocks_local.asp">
	<input type="hidden" name="next_page" value="Module_planesocks_local.asp">
