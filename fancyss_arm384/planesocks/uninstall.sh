...
dbus remove softcenter_module_planesocks_home_url
dbus remove softcenter_module_planesocks_install
dbus remove softcenter_module_planesocks_md5
dbus remove softcenter_module_planesocks_version
