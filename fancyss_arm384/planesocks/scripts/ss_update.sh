...
main_url="https://raw.githubusercontent.com/fastbash/fancyss/master/fancyss_arm384"
backup_url=""
...
update_ss2(){
	...
	echo_date "历史版本下载地址：https://github.com/fastbash/fancyss_history_package/tree/master/fancyss_arm384"
	echo_date "下载后请将下载包名字改为：planesocks.tar.gz，再使用软件中心离线安装功能进行安装！"
	sleep 1
	echo XU6J03M6
	exit
}
