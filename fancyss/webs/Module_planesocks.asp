...
function refresh_html() {
	...
	html += '<div class="nodeTable" style="top: ' + nodeT + 'px; width: 750px; height: ' + nodeH + 'px; overflow: hidden; position: absolute; margin-top: 10px;">'
									...
									<td bgcolor="#4D595D" colspan="3" valign="top">
										...
										<div id="tablet_2" style="display: none;">
											<table id="table_failover" style="margin:-1px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" >
												<script type="text/javascript">
													var fa1 = ["2", "3", "4", "5", "15", "30", "50"];
													var fa2_1 = ["10", "15", "20", "30", "50"];
													var fa2_2 = ["2", "3", "4", "5", "6", "7", "8", "30", "50"];
													var fa3_1 = ["10", "15", "20", "30", "50"];
													var fa3_2 = ["100", "150", "200", "250", "300", "350", "400", "450", "500", "1000", "1500", "2000"];
											...
											<table id="table_dns" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
												<script type="text/javascript">
													var option_dnsc = [
														...
														["2", "阿里DNS1【223.5.5.5】"], 
														["3", "阿里DNS2【223.6.6.6】"], 
														["4", "114DNS1【114.114.114.114】"], 
														["5", "114DNS2【114.114.115.115】"], 
														["6", "cnnic DNS1【1.2.4.8】"], 
														["7", "cnnic DNS2【210.2.4.8】"], 
														["8", "oneDNS1【117.50.11.11】"], 
														["9", "oneDNS2【117.50.11.22】"], 
														["10", "百度DNS【180.76.76.76】"], 
														["11", "DNSpod DNS【119.29.29.29】"], 
														["13", "SmartDNS"], 
														["12", "自定义DNS"]
													];
													var option_dnsf = [
													...
													var option_dnsr = [
														...
														["10", "百度DNS【180.76.76.76】"], 
														["11", "DNSpod DNS【119.29.29.29】"], 
														["13", "google DNS1【8.8.8.8】"], 
														["14", "google DNS2【8.8.4.4】"], 
														["15", "IBM DNS【9.9.9.9】"], 
														["16", "CloudFlare DNS【1.1.1.1】"], 
														["12", "自定义DNS"]
													];
													var option_resolv = [
														["ping", "ping"], 
													...
													$('#table_dns').forms([
														...
														{ title: '选择国外DNS', hint:'26', rid:'dns_plan_foreign', multi: [
															{ id: 'ss_foreign_dns', type:'select', func:'u', options:option_dnsf, style:'width:auto;',value:'3'},
														...
														{ title: '选择国外DNS', rid:'dns_plan_foreign_game2', multi: [																		//fancyss-koolgame
														...
														// { title: '域名解析方式', multi: [
														// 	{ suffix: '<input type="checkbox" id="ss_basic_ping_dns">使用ping解析', value: true }
														// ]},
														{ title: '节点域名解析方式', hint:'121', multi: [
															{ id: 'ss_basic_ping_dns', type:'select', func:'u', options:option_resolv, style:'width:auto;', value:'ping'},
												...
												<script type="text/javascript">
													...
													$('#table_rules').forms([
														...
														{ title: '规则定时更新任务', hint:'44', multi: [
															...
															{ id:'ss_basic_rule_update_time', type:'select', style:'width:auto', options:option_ruleu, value:'3'},
											...
											<table id="table_addons" style="margin:-1px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" >
												<script type="text/javascript">
													...
													$('#table_addons').forms([
														...
														{ title: '&nbsp;&nbsp;&nbsp;&nbsp;ping测试设置', id:'pingnone', style:'display:none;', multi: [
															{ id:'ss_basic_ping_node', type:'select', style:'width:auto;max-width:220px', func:'onchange="ping_switch();"', options:[],value: 'off'},
